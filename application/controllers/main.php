...
class Main extends MY_Controller {
    ...
    public function rating(){
        ...
        $p_config['first_tag1_open'] = "</li>";
        $p_config['last_tag_open'] = "<li>";
        $p_config['last_tag1_open'] = "</li>";
    ...
    public function contact(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($this->email->send()){
                $this->session->set_flashdata('msg','<div class="alert alert-succes text-center">Ваше сообщение 
                успешно отправлено!</div>');
                redirect('/contact');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-succes text-center">Произошла ошибка!</div>');
                redirect('/contact');
            }
